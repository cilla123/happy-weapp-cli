...
const HAPPY_WEAPP_TEMPLATE = 'https://github.com/cilla123/happy-weapp-template/archive/master.zip'
...
module.exports = (projectName) => {
    ...
    co(function *(){
        ...
        if (typeof projectName == 'object') {
            console.log(chalk.red(`创建失败，请输入项目名称`))
            return
        }
        ...
        inquirer.prompt(promps).then((answers) => {
            ...
            download(HAPPY_WEAPP_TEMPLATE, downloadPath, {
                extract: true
            }).then((data) => {
                // 关闭 loading
                spinner.stop();
